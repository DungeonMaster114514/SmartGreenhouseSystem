...
public class Images {
     ...
     * 图片地址
     */
    public static String url = "/main/java/com/ksamar/library/images/";
    ...
    public static Image greenhouseImage;
    public static ImageIcon greenhouseIcon;
    ...
    static {
        ...
        weatherBgImage = new ImageIcon(Objects.requireNonNull(Images.class.getResource(url + "weather_bg2.png"))).getImage();
