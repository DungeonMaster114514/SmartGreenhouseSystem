...
public class LineChart extends JPanel {
            ...
            if (updateTime.size() > i){
                ...
                if (parts.length >= 3){
                    ...
                    if ((i + 1) % 5 == 0) {
                        ...
                        g2.drawString(s, x - labelWidth / 2 + 3, datePositionY + 3); //+3是为了让时间显示偏右下
                    }
                }
            }
    ...
    public void setDatePositionY(int datePositionY) {
